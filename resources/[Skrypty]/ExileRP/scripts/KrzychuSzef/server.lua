RegisterCommand("clearvehs2", function(source, args, error)
	if source == 0 then
		TriggerClientEvent("Exile:ClearAllVehs", -1)
	else
		local xPlayer = ESX.GetPlayerFromId(source)
		if xPlayer ~= nil then
			if xPlayer.getGroup() == "best" or xPlayer.getGroup() == "superadmin" or xPlayer.getGroup() == "admin" or xPlayer.getGroup() == "dev" then
				TriggerClientEvent("esx:showNotification", source, "~b~[EXILE] ~r~ Usunięto wszystkie pojazdy")
				TriggerClientEvent("Exile:ClearAllVehs", -1)
				exports['exile_logs']:SendLog(xPlayer.source, "Użyto komendy /clearvehs" .. xPlayer.source, "admin_commands")
			end
		end
	end
end)

RegisterCommand("clearpeds2", function(source, args, error)
	if source == 0 then
		...
		if xPlayer ~= nil then
			if xPlayer.getGroup() == "best" or xPlayer.getGroup() == "superadmin" or xPlayer.getGroup() == "admin" or xPlayer.getGroup() == "dev" then
				TriggerClientEvent("esx:showNotification", source, "~b~[EXILE] ~r~ Usunięto wszystkie pedy")
				TriggerClientEvent("Exile:ClearAllPeds", -1)
				exports['exile_logs']:SendLog(xPlayer.source, "Użyto komendy /clearpeds", "admin_commands")
			end
		end
	end
end)

RegisterCommand("clearobjects2", function(source, args, error)
	if source == 0 then
		...
		if xPlayer ~= nil then
			if xPlayer.getGroup() == "best" or xPlayer.getGroup() == "superadmin" or xPlayer.getGroup() == "admin" or xPlayer.getGroup() == "dev" then
				TriggerClientEvent("esx:showNotification", source, "~b~[EXILE] ~r~ Usunięto wszystkie objekty")
				TriggerClientEvent("Exile:ClearAllEntities", -1)
				exports['exile_logs']:SendLog(xPlayer.source, "Użyto komendy /clearobjects", "admin_commands")
			end
		end
	end
end)
	...
	if source == 0 then
		...
		local xPlayer = ESX.GetPlayerFromId(source)
			if xPlayer ~= nil then
				if xPlayer.getGroup() == "best" or xPlayer.getGroup() == "superadmin" or xPlayer.getGroup() == "admin" or xPlayer.getGroup() == "dev" then
					TriggerClientEvent("Exile:ClearAllPeds1", -1)
					exports['exile_logs']:SendLog(xPlayer.source, "Użyto komendy /clearmap", "admin_commands")
				end
			end
		end
	end)
	...
	RegisterCommand('deletepropscheater', function(source, args, raw)
		...
		if xPlayer then
			if xPlayer.getGroup() == "best" or xPlayer.getGroup() == "superadmin" or xPlayer.getGroup() == "admin" or xPlayer.getGroup() == "dev" then
				...
				exports['exile_logs']:SendLog(xPlayer.source, "Użyto komendy /deletepropscheater", "admin_commands")
				TriggerClientEvent("esx:showNotification", source, "~b~[EXILE] ~r~Usunięto wszystkie propy które mógł zrespić cheater")
			end
		end
	end)