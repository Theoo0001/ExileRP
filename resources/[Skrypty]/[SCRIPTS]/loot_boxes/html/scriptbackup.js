                    ...
                    setTimeout(function() {
                        setTimeout(function() {
                            $("#CaseOpenCard46").addClass("winning-item"), $("body").on("keyup", function(e) {
                                27 == e.which && (window.location.reload(), $.post("http://loot_boxes/exile_boxes:NUIoff", JSON.stringify({})))
                            }), Swal.fire({
                                text: "Wygrałeś - " + i,
                                type: "success",
                                confirmButtonColor: "#77dd77",
                                confirmButtonText: "Odbierz"
                            }).then(function() {
                                window.location.reload(), $.post("http://loot_boxes/exile_boxes:NUIoff", JSON.stringify({}))
                            }, function() {
                                return !1
                            })
