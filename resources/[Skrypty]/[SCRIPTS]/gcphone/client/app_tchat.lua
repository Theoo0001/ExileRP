...
RegisterNetEvent("gcPhone:tchat_channelxdxdtesttesttest")
AddEventHandler("gcPhone:tchat_channelxdxdtesttesttest", function(channel, messages)
...
RegisterNUICallback('tchat_getChannel', function(data, cb)
  TriggerServerEvent('gcPhone:tchat_channelxdxdtesttesttest', data.channel)
end)
