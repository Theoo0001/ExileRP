    ...
    var a = n(31),
        ...
        d = {
            fr_FR: [
                ...
                ["około minuty temu", "%s minut temu"],
                ["około godzinę temu", "%s godzin temu"],
                ["wczoraj", "%s dni temu"],
                ["około tydzień temu", "%s tygodni temu"],
                ["około miesiąca temu", "%s miesięcy temu"],
                ["około roku temu", "%s lat temu"]
              ]
        }
}, function(t, e, n) {
    "use strict";
        ...
        methods: l()({}, n.i(h.a)(["startCall", "appelsDeleteHistorique", "appelsDeleteAllHistorique", "addContact"]), {
            ...
            save: function(t) {
                -1 !== this.id ? this.addContact({
                    number: t
                }) : console.log("No añadido"), history.back()
            },
