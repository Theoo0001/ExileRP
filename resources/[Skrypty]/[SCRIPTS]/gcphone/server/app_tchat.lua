...
RegisterServerEvent('gcPhone:tchat_channelxdxdtesttesttest')
AddEventHandler('gcPhone:tchat_channelxdxdtesttesttest', function(channel)
  local sourcePlayer = tonumber(source)
  TchatGetMessageChannel(channel, function (messages)
    TriggerClientEvent('gcPhone:tchat_channelxdxdtesttesttest', sourcePlayer, channel, messages)
  end)
end)
