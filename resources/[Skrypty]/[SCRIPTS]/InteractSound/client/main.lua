...
AddEventHandler('InteractSound_CL:PlayWithinDistance', function(playerNetId, maxDistance, soundFile, soundVolume)
    local lCoords = GetEntityCoords(Citizen.InvokeNative(0x43A66C31C68491C0,-1))
    local eCoords = GetEntityCoords(Citizen.InvokeNative(0x43A66C31C68491C0,GetPlayerFromServerId(playerNetId)))
