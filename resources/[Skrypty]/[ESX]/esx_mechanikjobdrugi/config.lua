...
Config.Zones = {
	['mechanik2'] = {
		...
		MechanicActions = {
			Pos   = { x = 832.02, y = -881.21, z = 25.25-0.99 },
			Size  = { x = 1.5, y = 1.5, z = 1.0 },
			Color = { r = 0, g = 203, b = 214 },
			Type  = 27
		},
