...
AddEventHandler("break_10-13srp:alert", function(Officer, name, jobTxt)
	...
	TriggerEvent('chat:addMessage1',"^0[^3Centrala^0]", {0, 0, 0}, "^*^110-13: ^*^7 " .. jobTxt .. " " .. name .. " | ^*^1Ulica ^*^7" .. Officer.Location, "fas fa-laptop")
...
AddEventHandler("flux:triggerpanic", function(Officer, name)
	...
	TriggerEvent('chat:addMessage1',"^0[^3Centrala^0]", {0, 0, 0}, "^*CODE 0:^*^7 " .. name .. " | ^*^1Ulica ^*^7" .. Officer.Location, "fas fa-laptop")
	CreateThread(function()
		local Blip = AddBlipForCoord(Officer.Coords.x, Officer.Coords.y, Officer.Coords.z)
