...
class Game {
     ...
     */
    static isControlPressed(index, control) {
     ...
     * @returns True or False.
     */
    static isControlJustPressed(index, control) {
     ...
     * @returns True or False.
     */
    static isDisabledControlJustPressed(index, control) {
     ...
     * @returns True or False.
     */
    static isControlReleased(index, control) {
     ...
     * @returns True or False.
     */
    static isControlJustReleased(index, control) {
