...
export declare class ParticleEffectAsset {
     ...
     */
    startNonLoopedAtCoord(effectName: string, pos: Vector3, rot?: Vector3, scale?: number, invertAxis?: IInvertAxis): boolean;
    /**
     ...
     * @param invertAxis Which axis to invert (default none).
     */
    startNonLoopedOnEntity(effectName: string, entity: Entity, off?: Vector3, rot?: Vector3, scale?: number, invertAxis?: IInvertAxis): boolean;
    /**
