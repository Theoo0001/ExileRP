...
Config.Discord = {
	Weapons = 'https://discord.com/api/webhooks/819732442012188672/Nsp4lqtFgUaYsUPCHAxXoKRTGHOGMb4gaxkNFH2iWAGyJ3cjfV6gOaxpOinlfPvl-_PM',
	Vehicles = 'https://discord.com/api/webhooks/819732478750228512/WA-TqpBjGRGmkI4DGIHO4KKfj1vyHzHJ5znxk9uSdEg_pQEOa6hM0kzXf0p7p1C_3vhJ',
	Objects = 'https://discord.com/api/webhooks/819732521666871306/4FSwSVL73VmzZT8pbvvxtvFmO4oe4OIKZGIeczgk8sngsgcoCXlel8eLYgSYK1vfMzpu',
	Peds = 'https://discord.com/api/webhooks/819732562560942120/oJGgPYX1lUacg6tqgbHSEq13qIP4cp7kaNfHbSgIUPhwOmYP8rR_bP40fEEAsgKUt1t2'
}
...
Config.Values = {
	...
	BObjects = {
		...
		--"prop_fnclink_05crnr1", -- KLATKA
		"sr_prop_spec_tube_xxs_01a"
	},

	BPeds = {
		"g_m_y_salvagoon_02",--VAGOSNIGGER
		"g_m_y_salvagoon_03",--VAGOSNIGGER
		"g_m_y_strpunk_01",--VAGOSNIGGER
		"g_m_y_strpunk_02",--VAGOSNIGGER
		"g_m_y_mexgang_01",--VAGOSNIGGER
		"csb_ramp_gang",--VAGOSNIGGER
		"g_m_y_mexgoon_02",--VAGOSNIGGER
		"g_m_y_mexgoon_03",--VAGOSNIGGER
		"g_m_y_pologoon_01",--VAGOSNIGGER
		"g_m_y_pologoon_02",--VAGOSNIGGER
		"g_m_y_salvaboss_01",--VAGOSNIGGER
		"g_m_y_mexgoon_01",--VAGOSNIGGER
		"csb_ortega",--VAGOSNIGGER
		"g_m_y_salvagoon_01",--VAGOSNIGGER
		"s_m_m_snowcop_01",
		"s_m_m_movalien_01",
		"s_m_y_sheriff_01",
		"u_m_y_imporage", 
